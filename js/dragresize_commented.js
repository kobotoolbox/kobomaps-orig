...
Modified by John Etherton to turn of resizing when we don't need it
...
DragResize.prototype.select = function(newElement) { with (this)
{
 ...
 if (newElement && (newElement != element) && enabled)
 {
  ...
  if(allow_resize) //don't turn on resizing if we don't want it
  {
...
DragResize.prototype.mouseMove = function(e) { with (this)
{
 ...
 {
  left =   elmX + 'px';
  //width =  elmW + 'px'; // I don't think we need this when just moving
  top =    elmY + 'px';
  //height = elmH + 'px'; // I don't think we need this when just moving
 }
