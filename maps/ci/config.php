...
/*Beginning primary map-specific variables*/
	$kmapPageTitle = "Côte d'Ivoire 2016 - Peacebuilding, Education and Resilience"; 
	$kmapTitle = "Côte d'Ivoire 2016 - Peacebuilding, Education and Resilience"; 
	$kmapAllAdminAreas = "Nationwide"; 
	$kmapY = "7.4"; 
	$kmapX = "-7.5"; 
	$kmapZoom = 7; 
...
<script type="text/javascript" language="javascript">
	...
	var kmapData = [
		{name: 'All Youth', url: "data_p1.php"},
		{name: 'Youth 12-17', url: "data_p2.php"},
		{name: 'Youth 18-26', url: "data_p3.php"}
	];
...
<link href="<?php echo kmapInstance ?>/custom.css" type="text/css" rel="stylesheet">
